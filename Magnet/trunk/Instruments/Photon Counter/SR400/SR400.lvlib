...
<Library LVVersion="8608001">
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Query" Type="Folder">
			...
			<Item Name="Query count display mode.vi" Type="VI" URL="../Public/Configure/Query count display mode.vi"/>
			...
			<Item Name="Query discriminator level (scan).vi" Type="VI" URL="../Public/Configure/Query discriminator level (scan).vi"/>
			...
			<Item Name="Query Trigger Slope.vi" Type="VI" URL="../Public/Configure/Query Trigger Slope.vi"/>
	...
	<Item Name="SR400 Readme.html" Type="Document" URL="../SR400 Readme.html"/>
</Library>
